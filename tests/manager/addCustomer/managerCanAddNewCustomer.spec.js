...
test('Assert manager can add new customer', async ({ page }) => {
  ...
  */
  ...
  await customersListPage.assertFirstNameCustomerInLastRow(firstName);
  await customersListPage.assertLastNameCustomerInLastRow(lastName);
  await customersListPage.assertPostCodeCustomerInLastRow(postCode);
